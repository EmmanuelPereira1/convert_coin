...
part of 'splash_view_controller.dart';
...
mixin _$SplashViewController on _SplashViewController, Store {
  late final _$setupStatusAtom =
      Atom(name: '_SplashViewController.setupStatus', context: context);
  ...
  late final _$checkTokenValidAsyncAction =
      AsyncAction('_SplashViewController.checkTokenValid', context: context);
