...
part of 'controller_success_register.dart';
...
mixin _$ControllerSuccessRegister on _ControllerSuccessRegisterBase, Store {
  late final _$setupStatusAtom = Atom(
      name: '_ControllerSuccessRegisterBase.setupStatus', context: context);
  ...
  late final _$checkTokenValidAsyncAction = AsyncAction(
      '_ControllerSuccessRegisterBase.checkTokenValid',
      context: context);
