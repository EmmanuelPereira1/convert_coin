...
part of 'controller_animate_logout.dart';
...
mixin _$ControllerAnimateLogout on _ControllerAnimateLogoutBase, Store {
  late final _$setupStatusAtom =
      Atom(name: '_ControllerAnimateLogoutBase.setupStatus', context: context);
  ...
  late final _$checkTokenValidAsyncAction = AsyncAction(
      '_ControllerAnimateLogoutBase.checkTokenValid',
      context: context);
